...
:: Check if the required files exist.
if exist "back\lib\IPee\libIpEe.a" (
    goto build
)
for %%f in (
    "libIpEeDictionary.a"
...
copy include\threadpool.h ..\..\%INTERNAL_FOLDER%\
copy include\event.h ..\..\%INTERNAL_FOLDER%\
copy include\macro.h ..\..\%INTERNAL_FOLDER%\
mkdir ..\..\lib\IPee
copy build\libIpEeDictionary.a ..\..\lib\IPee\
copy build\libIpEeContainer.a ..\..\lib\IPee\
copy build\libIpEeEvent.a ..\..\lib\IPee\
copy build\libIpEeThreadpool.a ..\..\lib\IPee\
